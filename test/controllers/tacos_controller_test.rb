...
class TacosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taco" do
    assert_difference('Taco.count') do
      post tacos_url, params: { taco: { cheese: @taco.cheese, name: @taco.name, tortilla: @taco.tortilla, type: @taco.type } }
    end
  ...
  test "should update taco" do
    patch taco_url(@taco), params: { taco: { cheese: @taco.cheese, name: @taco.name, tortilla: @taco.tortilla, type: @taco.type } }
